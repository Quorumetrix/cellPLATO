...
SAMPLING_INTERVAL = 30/60 # original was 0.5 # time between frames in minutes
TRACK_FILENAME = '.h5'
Z_SCALE = 1.00
...
DATA_PATH = 'D:/Michael_Shannon/MIGRATION_GRANT_FIGURES/combined_folders_noCh/'
CTL_LABEL = 'Condition_ICAM_nochemokine_day1_cp_masks'
CONDITIONS_TO_INCLUDE = ['Condition_ICAM_nochemokine_day1_cp_masks','Condition_ICAM_nochemokine_day2_cp_masks',
'Condition_Fibronectin_nochemokine_day1_cp_masks','Condition_Fibronectin_nochemokine_day2_cp_masks',] #'Condition_Stopped_artificial'

CONDITION_SHORTLABELS = ['ICAM', 'ICAM_withIL15','Fn','Fn_withIL15']

USE_SHORTLABELS = True
PERFORM_RIPLEYS = True
DATASET_SHORTNAME = 'Analysis-12-23-2022'
...
SAMPLING_INTERVAL_LIST= [30/60,30/60,30/60]#[1,1, 1/60,1/60]
...
'''
MIG_T_WIND = 4#6 # in frames
# MIG_T_WIND = ?? * SAMPLING_INTERVAL ''' To convert into seconds'''

MIN_CELLS_PER_TPT = 1 # used in: average_per_timepoint()

OUTPUT_PATH = 'D:/Michael_Shannon/MIGRATION_GRANT_FIGURES/combined_folders_noCh_OUTPUT/'
...
ARREST_THRESHOLD = 5 * SAMPLING_INTERVAL# microns - distance per step for arrest coefficient. Default 2 microns
...
ADDITIONAL_FACTORS = ['aspect','rip_L']
